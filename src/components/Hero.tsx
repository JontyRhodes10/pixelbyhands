...
const Hero = () => {
  return (
    <section
      id="group-1"
      className="relative min-h-screen bg-white dark:bg-gray-900 overflow-hidden transition-colors duration-300 flex items-center justify-center"
    >
      {/* Centered Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 lg:pr-8 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-black dark:text-white leading-tight mb-6 tracking-tight">
              Your{' '}
      ...
      <div className="absolute bottom-0 left-0 -z-10 w-1/3 h-screen bg-[#bb4430]/5 dark:bg-[#ff6b52]/5 blur-3xl"></div>
    </section>
  );
};
