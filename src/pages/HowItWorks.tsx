    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <section className="relative bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen flex flex-col lg:flex-row items-center py-24 lg:py-0">
            {/* Text Content */}
            <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left mb-12 lg:mb-0">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 dark:text-gray-100 mb-8">
                Great Product Images That Inspire Action
              </h2>
              
              <div className="space-y-6">
                <div className="text-base md:text-lg text-gray-600 dark:text-gray-300 space-y-6">
                  <p>
                    Starting with Pixel By Hand Image Editing Services could not be easier! All you need to do is to sign up for our <span className="text-[#bb4430] dark:text-[#ff6b52] font-semibold">FREE TRIAL</span> and upload the image that you need to be edited.
                  </p>
                  
                  <p>
                    Pixel By hand is more than an image editing company. We help you deliver success through a post-production partnership. Our photo editing services are designed to help your business reach its potential.
                  </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 px-4 lg:px-8">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white p-4 md:p-8 max-w-[90%] mx-auto">
                <img
      ...
      {/* Separator Section */}
      <section className="relative bg-[#bb4430] py-16 md:py-24 overflow-hidden">
      ...
      {/* Process Section */}
      <section 
        className="relative bg-fixed bg-cover bg-center py-16 md:py-24"
        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            {processSteps.map((step, index) => (
              <div 
                key={index}
                className="flex flex-col items-center text-center group bg-black/20 backdrop-blur-sm rounded-lg p-6 hover:bg-black/30 transition-all duration-300"
              >
      ...
      {/* Free Trial Section */}
      <section className="bg-[#bb4430] py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
